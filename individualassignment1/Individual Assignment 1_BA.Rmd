...
#are the two vectors the same size?
ifelse(length(filtered_price_pct_chg) == length(filtered_vol_pct_chg)
       ,"Yes, the two vectors are the same size"
       ,"No, the vectors are not the same size")
```
## TASK 3: Plot
